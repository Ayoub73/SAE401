...
<html>
	...
	<div id="main">
        ...
        $image_alt = htmlentities($_POST['image_alt']);
		$categorie = htmlentities($_POST['categorie']);
        $paragraphe = htmlentities($_POST['paragraphe']);

		$chemin_image = '../../../ressources/medias/' . $image;
        ...
        $ajouter_creation = $bdd -> prepare('INSERT INTO creations(titre, image, image_alt, categorie, paragraphe) VALUES(?, ?, ?, ?, ?)');
        $ajouter_creation -> execute(array($titre, $image, $image_alt, $categorie, $paragraphe));

		// Renvoie "Création ajouté !" pour affirmer que la compétence a bien été envoyé.
		echo "<div id=containNotif>
		
		<section id=notificationValide>

		<p id=message_valide>Création ajouté !</p>
		...
		header("Refresh: $delay;");
         ...
         ?>
        <h2 class="major">Ajouter une création</h2>
	    <!--  mettre un champ vide dans action pour éviter le retour à l'accueil.  --->
		...
		<div class="fields">
				...
				<div class="field half">
					<div class="illustration">
						...
						<img src="../medias/placeholder.png" onclick="triggerClick('#illustration')" id="illustration_display"/>
				...
				<textarea name="paragraphe" id="paragraphe" rows="7"></textarea>
				</div>
				</div>
